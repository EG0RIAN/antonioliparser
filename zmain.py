...
def pages_with_products():
    pages_pattern = "https:\/\/stores\.antonioli\.eu\/sitemap_products_[^<\s]+"
    return re.findall(pages_pattern, get_data("https://stores.antonioli.eu/sitemap.xml"))


def get_products(pages_link):
...
def start_parse(self, product_links):
